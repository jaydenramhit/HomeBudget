...
namespace BudgetCodeTests
{
    ...
    public class TestDatabase
    {
        ...
        [Fact]
        public void SQLite_TestExisitingDatabase_InvalidSQL()
        {
            // Arrange
            SQLiteConnection conn = Database.dbConnection;

            string stm = "not valid sql;";
        ...
        [Fact]
        public void SQLite_TestExistingDatabase_InvalidDbConnection()
        {
            // Arrange
            string filename = "";
            string cs = $"Data Source={filename}; Foreign Keys=1";
            SQLiteConnection dummyDatabaseConnection = new SQLiteConnection(cs);

            string stm = "SELECT Description FROM categories;";
            SQLiteCommand cmd = new SQLiteCommand(stm, dummyDatabaseConnection);
            bool exception = false;
